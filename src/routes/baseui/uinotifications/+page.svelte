...
<div class="hstack flex-wrap gap-2">
    ...
    <Button class="btn btn-info" id="borderedTost3Btn" on:click={() => (toast9 = !toast9)} >Warning Toast</Button>
...
<div style="z-index: 11">
    <Toast isOpen={toast9} id="borderedToast3" class="toast-border-info overflow-hidden mt-3">
        <ToastBody>
            <div class="d-flex align-items-center">
                <div class="flex-shrink-0 me-2">
