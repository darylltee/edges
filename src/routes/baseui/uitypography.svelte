...
<div class="bg-light clearfix">
    <Button color="primary" class="float-start">Example Button floated left</Button>
    <Button color="secondary" class="float-end">Example Button floated right</Button>
</div>
`;
</script>
					...
					<CardBody>
						...
						<div class="live-preview">
							<div class="bg-light clearfix p-3">
								<Button color="primary" class="float-start"
