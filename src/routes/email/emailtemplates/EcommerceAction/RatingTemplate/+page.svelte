                                            ...
                                            <tbody>
                                                <tr style="text-align: left;">
                                                    ...
                                                    <th style="padding: 5px;">
                                                        ...
                                                        <Link href="!#" itemprop="url" style="font-family: 'Roboto', sans-serif; box-sizing: border-box; font-size: .710rem;font-weight: 400; color: #FFF; text-decoration: none; text-align: center; cursor: pointer; display: inline-block; border-radius: .25rem; text-transform: capitalize; background-color: #0ab39c; margin: 0; border-color: #0ab39c; border-style: solid; border-width: 1px; padding: .25rem .5rem;" onMouseOver="this.style.background='#099885'" onMouseOut="this.style.background='#0ab39c'">Write a Review &#8594;</Link>
                                                    </th>
                                                </tr>
                                                <tr style="text-align: left;">
                                                    <th style="padding: 5px;width: 110px;">
