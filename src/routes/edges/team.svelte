                    ...
                    <CardBody class="text-center p-4">
                        ...
                        <h5 class="mb-1">
                            <Link
                                ...
                                class="text-body">Nancy Martino</Link
                            >
                        </h5>
                ...
                <Card>
                    <CardBody class="text-center p-4">
                        ...
                        <h5 class="mb-1">
                            <Link
                                href="/pages/profile/simple/simplepage"
                                class="text-body">Henry Baird</Link
                            >
                        </h5>
                ...
                <Card>
                    <CardBody class="text-center p-4">
                        ...
                        <h5 class="mb-1">
                            <Link
                                href="/pages/profile/simple/simplepage"
                                class="text-body">Frank Hook</Link
                            >
                        </h5>
                        <p class="text-muted mb-0 ff-secondary">
                            Project Manager
                ...
                <Card>
                    <CardBody class="text-center p-4">
                        ...
                        <h5 class="mb-1">
                            <Link
                                href="/pages/profile/simple/simplepage"
                                class="text-body">Donald Palmer</Link
                            >
                        </h5>
                        <p class="text-muted mb-0 ff-secondary">
                            UI/UX Designer
                ...
                <Card>
                    <CardBody class="text-center p-4">
                        ...
                        <h5 class="mb-1">
                            <Link
                                href="/pages/profile/simple/simplepage"
                                class="text-body">Erica Kernan</Link
                            >
                        </h5>
                ...
                <Card>
                    <CardBody class="text-center p-4">
                        ...
                        <h5 class="mb-1">
                            <Link
                                href="/pages/profile/simple/simplepage"
                                class="text-body">Alexis Clarke</Link
                            >
                        </h5>
                        <p class="text-muted mb-0 ff-secondary">
                            Backend Developer
                ...
                <Card>
                    <CardBody class="text-center p-4">
                        ...
                        <h5 class="mb-1">
                            <Link
                                href="/pages/profile/simple/simplepage"
                                class="text-body">Marie Ward</Link
                            >
                        </h5>
                        <p class="text-muted mb-0 ff-secondary">
                            Full Stack Developer
                ...
                <Card>
                    <CardBody class="text-center p-4">
                        ...
                        <h5 class="mb-1">
                            <Link
                                href="/pages/profile/simple/simplepage"
                                class="text-body">Jack Gough</Link
                            >
                        </h5>
                        <p class="text-muted mb-0 ff-secondary">
                            React Js Developer
