            ...
            <Col lg={6}>
                <div class="text-muted">
                    ...
                    <p class="mb-4 ff-secondary fs-16">
                        Collection widgets specialize in displaying many
                        elements of the same type, such as a collection of
                        pictures from a collection of articles from a news app
                        or a collection of messages from a communication app.
                    </p>
            ...
            <Col class="col-sm-auto">
                <div>
                    <Link
                        ...
                        ><i class="ri-shopping-cart-2-line align-middle me-1" />
                        Buy Now</Link
                    >
                </div>
            </Col>
            ...
            <Col lg={6} class="order-2 order-lg-1">
                <div class="text-muted">
                    ...
                    <p class="mb-4 ff-secondary">
                        Quality Dashboards (QD) is a condition-specific,
                        actionable web-based application for quality reporting
                        and population management that is integrated into the
        ...
        <Row class="align-items-center mt-5 pt-lg-5 gy-4">
            ...
            <Col lg={6}>
                <div class="text-muted ps-lg-5">
                    ...
                    <p class="mb-4">
                        used to describe something that is known about or known
                        to be true because there are many documents that
                        describe it, prove it, etc.
                    </p>
