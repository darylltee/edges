            ...
            <Col lg={8}>
                <div class="text-center mb-5">
                    ...
                    <p class="text-muted mb-4 ff-secondary">
                        ...
                        would acknowledge the importance of having web copy
                        before the Proin vitae ipsum vel ex finibus semper
                        design starts.
                    </p>
                </div>
            </Col>
            ...
            <Col lg={4}>
                <div class="process-card mt-4">
                    ...
                    <p class="text-muted ff-secondary">
                        The profession and the employer and your desire to make
                        your mark.
                    </p>
                </div>
            </Col>
