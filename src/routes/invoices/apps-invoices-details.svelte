				...
				<Card id="demo">
					<CardHeader class="border-bottom-dashed p-4">
						<div class="d-sm-flex">
							...
							<div class="flex-shrink-0 mt-sm-0 mt-3">
								...
								<h6 class="mb-0">
									<span class="text-muted fw-normal">Contact No: </span><span
										id="contact-no"
									>
										+(01) 234 6789</span
									>
					...
					<CardBody class="p-4">
							...
							>
								...
								<tbody id="products-list">
									...
									<tr>
										...
										<td class="text-start">
											<span class="fw-medium"
												>Fabric Dual Tone Living Room Chair</span
											>
						...
						<div class="border-top border-top-dashed mt-2">
							...
							>
								<tbody>
									...
									<tr>
										<td
											>Discount <small class="text-muted">(VELZON15)</small></td
										>
						...
						<div class="mt-3">
							...
							<p class="text-muted mb-1">
								Payment Method: <span class="fw-medium" id="payment-method"
									>Mastercard</span
								>
							</p>
							<p class="text-muted mb-1">
								Card Holder: <span class="fw-medium" id="card-holder-name"
									>David Nichols</span
								>
							</p>
							<p class="text-muted mb-1">
								Card Number: <span class="fw-medium" id="card-number"
						...
						<div class="hstack gap-2 justify-content-end d-print-none mt-4">
							<button
								...
								><i class="ri-printer-line align-bottom me-1" /> Print</button
							>
							<Link href={null} class="btn btn-primary"
								><i class="ri-download-2-line align-bottom me-1" /> Send Invoice</Link
							>
						</div>
					</CardBody>
					<!--end card-body-->
