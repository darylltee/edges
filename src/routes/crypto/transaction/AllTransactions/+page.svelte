    ...
    const columns = [
        ...
        },
        {
            ...
            formatter: (cell) => {
                if (cell === "Processing") {
                    return html(
                        `<span class='badge badge-soft-primary fs-11'><i class="ri-time-line align-bottom"></i>${cell}</span>`
                    );
...
<Row class="align-items-center mb-4 g-3">
    ...
    <div class="col-sm-auto ms-auto">
        <div class="d-flex gap-2">
            <Link href="#!" data-bs-toggle="modal" class="btn btn-soft-secondary"
                >Deposite</Link
            >
            <Link href="#!" data-bs-toggle="modal" class="btn btn-soft-success"
                >Withdraw</Link
            >
        </div>
    </div>
