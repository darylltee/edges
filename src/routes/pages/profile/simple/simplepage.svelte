									...
									<Card>
										<CardBody>
											...
											>
												...
												<SwiperSlide>
													<Card class="profile-project-card shadow-none profile-project-success mb-0">
														<CardBody class="p-4">
															<div class="d-flex">
																<div class="flex-grow-1 text-muted overflow-hidden">
																	<h5 class="fs-14 text-truncate mb-1">
													...
													<tbody>
																...
																<div class="d-flex align-items-center">
																	...
																	<div class="ms-3 flex-grow-1">
																		<h6 class="fs-15 mb-0"><a
																				href="{null}" class="link-secondary">Artboard-documents.zip</a>
																		</h6>
																	</div>
																</div>
															</td>
														...
														<tr>
															<td>
																<div class="d-flex align-items-center">
																	...
																	<div class="ms-3 flex-grow-1">
																		<h6 class="fs-15 mb-0"><a
																				href="{null}" class="link-secondary">Bank
														...
														<tr>
															<td>
																<div class="d-flex align-items-center">
																	...
																	<div class="ms-3 flex-grow-1">
																		<h6 class="fs-15 mb-0"><a
																				href="{null}" class="link-secondary">Tour-video.mp4</a>
																		</h6>
																	</div>
																</div>
															</td>
														...
														<tr>
															<td>
																<div class="d-flex align-items-center">
																	...
																	<div class="ms-3 flex-grow-1">
																		<h6 class="fs-15 mb-0"><a
																				href="{null}" class="link-secondary">Account-statement.xsl</a>
																		</h6>
																	</div>
																</div>
															</td>
														...
														<tr>
															<td>
																<div class="d-flex align-items-center">
																	...
																	<div class="ms-3 flex-grow-1">
																		<h6 class="fs-15 mb-0"><a
																				href="{null}" class="link-secondary">Project
														...
														<tr>
															<td>
																<div class="d-flex align-items-center">
																	<div class="avatar-sm">
																		<div class="avatar-title bg-slight text-primary rounded fs-20">
																			<i class="ri-image-2-fill"></i>
																		</div>
																	</div>
																	<div class="ms-3 flex-grow-1">
																		<h6 class="fs-15 mb-0"><a
																				href="{null}" class="link-secondary">Velzon-logo.png</a>
																		</h6>
																	</div>
																</div>
															</td>
