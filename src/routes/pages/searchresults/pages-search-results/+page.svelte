	...
	const video = [
		{
			...
			siteLink: '//themesbrand.com/velzon/index.html',
						...
						<TabContent {activeTab} class="text-muted">
							<TabPane tabId={1} class={activeTab == 1 ? 'active' : ''}>
								<div class="pb-3">
									...
									<p class="text-success mb-2">//themesbrand.com/velzon/index.html</p>
								...
								<div class="py-3">
									...
									<p class="text-success mb-2">//themesbrand.com/skote/</p>
									<p class="text-muted mb-2">
								...
								<div class="py-3">
									...
									<p class="text-success mb-2">//themesbrand.com/minia/react/</p>
									<p class="text-muted mb-2">
								...
								<div class="py-3">
									...
									<p class="text-success mb-2">//themesbrand.com/dason/angular/</p>
									<p class="text-muted mb-2">
