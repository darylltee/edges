                    ...
                    <CardBody>
                        <div class="d-flex align-items-center mb-3">
                            ...
                            <div class="ms-2 flex-grow-1">
                                <Link href="#!"><h6 class="mb-1 fs-15">{item.author}</h6></Link>
                        ...
                        <div class="mt-3">
                            ...
                            <h6 class="fs-16 mb-0"><Link href="/NFTmarketplace/Itemdetails/apps-nft-item-details" class="link-dark">{item.category}</Link></h6>
                        </div>
                    </CardBody>
                </Card>
            </Col>
