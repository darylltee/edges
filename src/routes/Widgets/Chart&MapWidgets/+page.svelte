    ...
    <Col xxl={4} xl={6}>
        <Card class="card-height-100">
            <CardHeader class="align-items-center d-flex">
                ...
                <div>
                    <Button color="secondary" size="sm" class="btn-soft-primary me-1">
                        ALL
                    </Button>
                    <Button color="primary" size="sm" class="btn-soft-primary me-1">
                        1M
                    </Button>
                    <Button color="secondary" size="sm" class="btn-soft-primary">
                        6M
                    </Button>
                </div>
            </CardHeader>
            <CardBody class="p-0">
                <div>
                    <div id="countries_charts" class="apex-charts" dir="ltr">
                        <SessionsByCountriesCharts dataColors={["--vz-primary", "--vz-primary", "--vz-primary", "--vz-primary", "--vz-info", "--vz-primary", "--vz-primary", "--vz-primary", "--vz-primary", "--vz-info"]} />
                    </div>
                </div>
            </CardBody>
        </Card>
                    ...
                    <ListGroupItem class="px-0">
                        <div class="d-flex">
                            ...
                            <div class="flex-grow-1 ms-2">
                                ...
                                <p class="fs-12 mb-0 text-muted"><i class={"mdi mdi-circle fs-10 align-middle me-1 text-" + item.coinNameClass}></i>{item.coinName}</p>
                            </div>
