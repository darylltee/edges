                ...
                <div class="mx-n3 pt-4 px-4 file-manager-content-scroll" data-simplebar>
                        ...
                        <Row class="justify-content-beetwen g-2 mb-3">
                            ...
                            <Col class="col-auto">
                                <div class="d-flex gap-2 align-items-start">
                                    ...
                                    <button class="btn btn-primary w-sm create-folder-modal flex-shrink-0"><i class="ri-add-line align-bottom me-1"></i> Create Folders</button>
                                </div>
                            </Col>
                        </Row>
                    ...
                    <div>
                        <div class="d-flex align-items-center mb-3">
                            ...
                            <div class="flex-shrink-0">
                                <button class="btn btn-primary createFile-modal"><i class="ri-add-line align-bottom me-1"></i> Create File</button>
                            </div>
                        </div>
            ...
            <div class="file-manager-detail-content p-3 py-0 border">
                <div class="mx-n3 pt-3 px-3 file-detail-content-scroll" data-simplebar>
                    <div id="folder-overview">
                        ...
                        <SimpleDonutCharts dataColors={["--vz-info", "--vz-warning", "--vz-primary", "--vz-success"]} class="apex-charts mt-3" dir="ltr" />
                        <div class="mt-4">
