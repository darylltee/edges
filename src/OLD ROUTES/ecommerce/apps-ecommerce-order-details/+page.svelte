					...
					<CardHeader>
						<div class="d-sm-flex align-items-center">
							...
							<div class="flex-shrink-0 mt-2 mt-sm-0">
								<Link href="javasccript:void(0;)" class="btn btn-soft-primary btn-sm mt-2 mt-sm-0"
									><i class="ri-map-pin-line align-middle me-1" /> Change Address</Link
								>
								<Link href="javasccript:void(0;)" class="btn btn-soft-secondary btn-sm mt-2 mt-sm-0"
				...
				<Card>
					<CardHeader>
						<div class="d-flex">
							...
							<div class="flex-shrink-0">
								<Link href="{null}" class="badge badge-soft-primary fs-11">Track Order</Link>
							</div>
						</div>
					</CardHeader>
					<CardBody>
