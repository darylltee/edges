		...
		if (parentCollapseDiv) {
			...
			if (parent.closest(".collapse.menu-dropdown")) {
				...
				if (parentElementDiv) {
					...
					if (
						parentElementDiv.parentElement.closest(".collapse.menu-dropdown")
					) {
						var parentParent = parentElementDiv.parentElement.closest(
										...
										{#if !subItem.isChildItem}
											<li class="nav-item">
												<Link
													...
													href={subItem.link}
													on:click={() =>
														changeClassAttribute("", item.id, subItem.id)}
												>
													{$_(subItem.label)}
										...
										{:else}
											<li class="nav-item">
												<Link
													...
													aria-expanded={current_child === subItem.id
														? "true"
														: "false"}
													id={subItem.id}
													on:click={(e) =>
