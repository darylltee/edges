	...
	{:else if item.subItems}
		<li class="nav-item">
			...
			{#if item.id === "dashboard"}
				<HomeIcon class="icon-dual" size="24" />
			{:else if item.id === "apps"}
				<GridIcon class="icon-dual" size="24" />
			{:else if item.id === "authentication"}
				<UsersIcon class="icon-dual" size="24" />
			{:else if item.id === "pages"}
				<CommandIcon class="icon-dual" size="24" />
			{:else if item.id === "landing"}
				<i class="ri-rocket-line"></i>
			{:else if item.id === "baseUi"}
				<PackageIcon class="icon-dual" size="24" />
			{:else if item.id === "advanceUi"}
				<LayersIcon class="icon-dual" size="24" />
			{:else if item.id === "widgets"}
				<CopyIcon class="icon-dual" size="24" />
			{:else if item.id === "forms"}
				<FileTextIcon class="icon-dual" size="24" />
			{:else if item.id === "tables"}
				<DatabaseIcon class="icon-dual" size="24" />
			{:else if item.id === "charts"}
				<PieChartIcon class="icon-dual" size="24" />
			{:else if item.id === "icons"}
				<ArchiveIcon class="icon-dual" size="24" />
			{:else if item.id === "maps"}
				<MapPinIcon class="icon-dual" size="24" />
			{:else if item.id === "multilevel"}
				<Share2Icon class="icon-dual" size="24" />
			{/if}
